...
StoryPop 是一个 Chrome 侧边栏插件，帮助短视频创作者和普通用户把口语化故事描述，自动转换成结构化分镜脚本、AI 视频生成提示词和可选 BGM 提示词。
...
StoryPop 面向短视频创作者、自媒体运营、营销人员，以及想把生日、婚礼、旅行、纪念日等生活故事做成 AI 视频的普通用户，让他们在 Chrome 侧边栏中输入自然语言故事后，快速得到可读、可编辑、可复制、可导出的分镜和提示词。
...
**验收标准：**
- [ ] Given 用户打开 StoryPop Chrome 侧边栏，When 用户输入或粘贴故事文本，Then 系统应保留文本并展示可生成状态。
